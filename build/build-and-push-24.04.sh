...
git fetch --tags
# Force checkout — discards local Dockerfile changes from previous runs
git checkout -f "${NETBOX_VERSION}"

# Always start fresh — delete previous .netbox to ensure correct version
rm -rf .netbox
